...
export declare namespace MemoryUpdateMemoryParams {
    /**
     * Structured temporal metadata. Merged into the metadata JSON column. If omitted,
     * existing temporalContext is preserved.
     */
...
export declare namespace Memories {
    export { type MemoryForgetResponse as MemoryForgetResponse, type MemoryUpdateMemoryResponse as MemoryUpdateMemoryResponse, type MemoryForgetParams as MemoryForgetParams, type MemoryUpdateMemoryParams as MemoryUpdateMemoryParams, };
}
