...
export declare class Documents extends APIResource {
     ...
     * ```
     */
    deleteBulk(body: DocumentDeleteBulkParams, options?: RequestOptions): APIPromise<DocumentDeleteBulkResponse>;
    /**
...
export declare namespace DocumentListResponse {
    interface Memory {
         ...
         */
        type: 'text' | 'pdf' | 'tweet' | 'google_doc' | 'google_slide' | 'google_sheet' | 'image' | 'video' | 'audio' | 'notion_doc' | 'webpage' | 'onedrive' | 'github_markdown';
        /**
